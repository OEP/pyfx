...
namespace vr
{
  class Image
  {
    ...
    public:
      ...
      void add(size_t i, size_t j, float value, size_t wt=1);
      void add(size_t i, size_t j, const Image::Pixel &p, size_t wt=1);
      void add(size_t i, size_t j, const Color &value, size_t wt=1);
